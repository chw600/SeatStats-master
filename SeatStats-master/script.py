...
if __name__ == '__main__':
    ...
    argparser.add_argument('--stu-info', type=str, default=r'大学计算机C班（电信1-2班、土木、环境）.xlsx', help='学生姓名表')
    argparser.add_argument('--save-dir', type=str, default='周四78节T3201座位表.xlsx', help='输出的座位表')
